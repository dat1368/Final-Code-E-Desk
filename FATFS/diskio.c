 ...
 void power (void)
{
	...
	SPI_Cmd(SPI_SD, ENABLE);
        ...
        GPIO_PinAFConfig(GPIOB,GPIO_PinSource5,GPIO_AF_SPI1);   // only connect to 
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource3,GPIO_AF_SPI1);   // only connect to 
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource4,GPIO_AF_SPI1);   // only connect to 
