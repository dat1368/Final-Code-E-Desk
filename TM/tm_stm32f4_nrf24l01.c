...
void TM_NRF24L01_SetMyAddress_Multiciver(uint8_t *adr0,uint8_t *adr1,uint8_t *adr2,uint8_t *adr3,uint8_t *adr4,uint8_t *adr5) {
	NRF24L01_CE_LOW;
	TM_NRF24L01_WriteRegisterMulti(NRF24L01_REG_RX_ADDR_P0, adr0, 5);
	TM_NRF24L01_WriteRegisterMulti(NRF24L01_REG_RX_ADDR_P1, adr1, 5);
	TM_NRF24L01_WriteRegisterMulti(NRF24L01_REG_RX_ADDR_P2, adr2, 5);

	//TM_NRF24L01_WriteRegister(NRF24L01_REG_RX_ADDR_P2, *adr2);
	TM_NRF24L01_WriteRegister(NRF24L01_REG_RX_ADDR_P3, *adr3);
	TM_NRF24L01_WriteRegister(NRF24L01_REG_RX_ADDR_P4, *adr4);
	TM_NRF24L01_WriteRegister(NRF24L01_REG_RX_ADDR_P5, *adr5);
	NRF24L01_CE_HIGH;
}
