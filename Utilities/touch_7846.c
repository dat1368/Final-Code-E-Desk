...
{	
  ...
  GPIO_PinAFConfig(GPIOA, GPIO_PinSource5, GPIO_AF_SPI1); //sclk	10	 13
  GPIO_PinAFConfig(GPIOA, GPIO_PinSource6, GPIO_AF_SPI1);	//MOSO	11	 14
  ...
  GPIO_Init(GPIOA,&GPIO_InitStruct);    // d  	    			
  T_DCS(); 				 
  //T_PEN				
